...
f1, f2 :TDate;
begin
  f1:= Form4.DateTimePicker1.Date;
  f2:= ((Form4.DateTimePicker2.Date)+1);

   DataModule1.Queryfechas.Close;
   DataModule1.Queryfechas.ParamByName('fecha1').AsDate:= f1;
   DataModule1.Queryfechas.ParamByName('fecha2').AsDate := f2;
   DataModule1.Queryfechas.Open;
     if DataModule1.Queryfechas.EOF then
        begin
        DataModule1.ClientDataSet5.Refresh;
        ShowMessage('La Fecha no se ha encontrado');
        end
        else
        begin
        DataModule1.ClientDataSet5.Refresh;
        ShowMessage('La Fecha se ha encontrado con Exito');
        end;
end;
...
f1, f2 :string;
begin
  f1:= DateToStr(Form4.DateTimePicker1.Date);
  f2:= DateToStr(Form4.DateTimePicker2.Date);
  Form4.frxReportfechas.Variables.Variables['FECHA1']:= QuotedStr(f1);
  Form4.frxReportfechas.Variables.Variables['FECHA2']:= QuotedStr(f2);
  Form4.frxReportfechas.ShowReport;
end;
